...
<p>
    <?php echo $this->Html->link(__d('cake_dev', 'Read the changelog'), 'https://github.com/pieceofcake2/cakephp/releases/tag/v' . Configure::version()); ?>
</p>
<?php
...
<p>
    ...
    if (CakePlugin::loaded('DebugKit')):
        ...
        echo '<span class="notice">';
            ...
            echo '<br/>';
            echo __d('cake_dev', 'You can install it from %s', $this->Html->link('GitHub', 'https://github.com/pieceofcake2/debug_kit/tree/2.2'));
        echo '</span>';
    endif;
    ?>
</p>
...
<ul>
    <li>
        <?php echo $this->Html->link('DebugKit', 'https://github.com/pieceofcake2/debug_kit') ?>:
        <?php echo __d('cake_dev', 'provides a debugging toolbar and enhanced debugging tools for CakePHP applications.'); ?>
    </li>
    <li>
        <?php echo $this->Html->link('Localized', 'https://github.com/pieceofcake2/localized') ?>:
...
<ul>
    ...
    <li><a href="https://github.com/pieceofcake2/"><?php echo __d('cake_dev', 'CakePHP Code'); ?> </a>
    <ul><li><?php echo __d('cake_dev', 'Find the CakePHP code on GitHub and contribute to the framework'); ?></li></ul></li>
    <li><a href="https://github.com/pieceofcake2/cakephp/issues"><?php echo __d('cake_dev', 'CakePHP Issues'); ?> </a>
    <ul><li><?php echo __d('cake_dev', 'CakePHP Issues'); ?></li></ul></li>
    <li><a href="https://github.com/pieceofcake2/cakephp/wiki#roadmaps"><?php echo __d('cake_dev', 'CakePHP Roadmaps'); ?> </a>
